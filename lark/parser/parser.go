...
func (p *Parser) parseIndexExpression(left ast.Expression) ast.Expression {
	idxExpression := &ast.IndexExpression{Token: p.curToken, Left: left}

	p.nextToken()

	idxExpression.Index = p.parseExpression(LOWEST)
